...
public abstract class AbstractDashboardVO2MaxWidget extends AbstractGaugeWidget implements DashboardVO2MaxWidgetInterface {
    ...
    public static int[] getColors() {
        return new int[]{
                ContextCompat.getColor(WearableApplication.getContext(), R.color.vo2max_value_poor_color),
                ContextCompat.getColor(WearableApplication.getContext(), R.color.vo2max_value_fair_color),
                ContextCompat.getColor(WearableApplication.getContext(), R.color.vo2max_value_good_color),
                ContextCompat.getColor(WearableApplication.getContext(), R.color.vo2max_value_excellent_color),
                ContextCompat.getColor(WearableApplication.getContext(), R.color.vo2max_value_superior_color),
        };
    }
