...
public abstract class AbstractDashboardWidget extends Fragment {
    ...
    protected HomeFragment.DashboardData dashboardData;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            dashboardData = (HomeFragment.DashboardData) getArguments().getSerializable(ARG_DASHBOARD_DATA);
        }
    }
    ...
    protected List<GBDevice> getSupportedDevices(final HomeFragment.DashboardData dashboardData) {
    ...
    protected void chooseDevice(final HomeFragment.DashboardData dashboardData,
