...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREFS_PER_APP_NOTIFICATION_SETTINGS;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_AGPS_EXPIRY_REMINDER_ENABLED;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_AGPS_EXPIRY_REMINDER_TIME;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALERT_TONE;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_FOLLOW_WATCHFACE;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_OFF;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_SCHEDULED;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_STYLE;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CLAP_HANDS_TO_WAKEUP_DEVICE;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CONTACTS;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_COVER_TO_MUTE;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CROWN_VIBRATION;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CYCLING_SENSOR_PERSISTENCE_INTERVAL;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CYCLING_SENSOR_WHEEL_DIAMETER;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DO_NOT_DISTURB_OFF;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DO_NOT_DISTURB_SCHEDULED;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_FEMOMETER_MEASUREMENT_MODE;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_GPS_BAND;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_GPS_COMBINATION;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_GPS_MODE_PRESET;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_GPS_SATELLITE_SEARCH;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HEARTRATE_AUTOMATIC_ENABLE;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_MIJIA_LYWSD_COMFORT_HUMIDITY_LOWER;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_MIJIA_LYWSD_COMFORT_HUMIDITY_UPPER;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_MIJIA_LYWSD_COMFORT_TEMPERATURE_LOWER;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_MIJIA_LYWSD_COMFORT_TEMPERATURE_UPPER;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_MISCALE_SMALL_OBJECTS;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_MUSIC_MANAGEMENT;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_LANGUAGE;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_RESPOND_SCREEN_ON;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_RESPOND_TURN_WRIST;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_RESPONSE_DURING_SCREEN_LIGHTING;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_PHONE_SILENT_MODE;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_PREFIX_NOTIFICATION_WITH_APP;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SLEEP_MODE_SCHEDULE_ENABLED;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SLEEP_MODE_SCHEDULE_END;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SLEEP_MODE_SCHEDULE_START;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SPO_AUTOMATIC_ENABLE;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_TEMPERATURE_SCALE_CF;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_TEXT_TO_SPEECH;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_UM25_SHOW_THRESHOLD;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_UM25_SHOW_THRESHOLD_NOTIFICATION;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_USER_FITNESS_GOAL;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_USER_FITNESS_GOAL_SECONDARY;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_VIBRATE_FOR_ALERT;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_VITALITY_SCORE_7_DAY;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_VITALITY_SCORE_DAILY;
...
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_VOLUME;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WEARDIRECTION;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WEARMODE;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WIDGETS;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WORKOUT_DETECTION_ALERT;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WORKOUT_DETECTION_CATEGORIES;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WORKOUT_DETECTION_SENSITIVITY;
import static nodomain.freeyourgadget.gadgetbridge.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WORLD_CLOCKS;
...
/**
 * Separated common fragment class for device and device sub-settings.
 * The entire thing, especially with setChangeListener() is just a mess,
 * so separate that entire behemoth from the fragment initialization classes.
 */
public abstract class DeviceSettingsFragmentCommon extends AbstractPreferenceFragment implements DeviceSpecificSettingsHandler {
    protected DeviceSpecificSettings mDeviceSpecificSettings;

    protected DeviceSpecificSettingsCustomizer mCustomizer;

    protected GBDevice mDevice;
    protected PreferenceScreen mPreferenceScreen;

    protected void setSettingsFileSuffix(String settingsFileSuffix) {
        Bundle args = new Bundle();
        args.putString("settingsFileSuffix", settingsFileSuffix);
        setArguments(args);
    }

    protected void setDeviceSpecificSettings(final DeviceSpecificSettings deviceSpecificSettings) {
        final Bundle args = getArguments() != null ? getArguments() : new Bundle();
        args.putParcelable("deviceSpecificSettings", deviceSpecificSettings);
        setArguments(args);
    }

    protected void setCustomizer(final DeviceSpecificSettingsCustomizer customizer) {
        final Bundle args = getArguments() != null ? getArguments() : new Bundle();
        args.putParcelable("deviceSpecificSettingsCustomizer", customizer);
        setArguments(args);
    }

    protected void setDevice(final GBDevice device) {
        final Bundle args = getArguments() != null ? getArguments() : new Bundle();
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (arguments == null) {
            LOG.error("No arguments provided, cannot create preferences");
            return;
        }

        String settingsFileSuffix = arguments.getString("settingsFileSuffix", null);
        this.mDeviceSpecificSettings = arguments.getParcelable("deviceSpecificSettings");
        this.mCustomizer = arguments.getParcelable("deviceSpecificSettingsCustomizer");
        this.mDevice = arguments.getParcelable("device");
        onSavedInstanceState(savedInstanceState);

        if (settingsFileSuffix == null || mDeviceSpecificSettings == null) {
            LOG.error("No settings file suffix or device specific settings provided, cannot create preferences");
            return;
        }

        getPreferenceManager().setSharedPreferencesName("devicesettings_" + settingsFileSuffix);
        onSetupPreferences(rootKey);
    ...
    protected void onSetupPreferences(String rootKey) {
    ...
    private void setChangeListener(final String rootKey) {
        ...
        if (languageListPreference != null) {
            final String[] supportedLanguages = coordinator.getSupportedLanguageSettings(mDevice);
...
//        addPreferenceHandlerFor(PREF_REDMI_BUDS_PERSONALIZED_NOISE_CANCELLING);
        ...
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_SINGLE_TAP_RIGHT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_DOUBLE_TAP_LEFT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_DOUBLE_TAP_RIGHT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_TRIPLE_TAP_LEFT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_TRIPLE_TAP_RIGHT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_LEFT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_RIGHT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_SETTINGS_LEFT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_SETTINGS_RIGHT);

        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_SETTINGS_LEFT_CATEGORY);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_SETTINGS_RIGHT_CATEGORY);

        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_LEFT_AMBIENT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_LEFT_ANC);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_LEFT_OFF);

        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_RIGHT_AMBIENT);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_RIGHT_ANC);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_CONTROL_LONG_TAP_MODE_RIGHT_OFF);
...
//        addPreferenceHandlerFor(PREF_REDMI_BUDS_SURROUND_SOUND_MODE);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_PRESET);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_62);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_125);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_250);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_500);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_1k);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_2k);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_4k);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_8k);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_12k);
        addPreferenceHandlerFor(PREF_REDMI_BUDS_EQUALIZER_BAND_16k);
        ...
        if (phoneSilentMode != null) {
            phoneSilentMode.setOnPreferenceChangeListener((preference, newVal) -> {
                ...
                WearableApplication.deviceService(mDevice).onChangePhoneSilentMode(audioManager.getRingerMode());
                return true;
            });
        }
        ...
        final int cannedRepliesSlotCount = coordinator.getCannedRepliesSlotCount(mDevice);
        ...
        if (cannedMessagesDismissCall != null) {
            cannedMessagesDismissCall.setOnPreferenceClickListener(new androidx.preference.Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(androidx.preference.Preference preference) {
                    ...
                    WearableApplication.deviceService(mDevice).onSetCannedMessages(cannedMessagesSpec);
                    return true;
                }
            });
        ...
        if (mCustomizer != null) {
            mCustomizer.customizeSettings(this, prefs, rootKey);
        }
    }
    ...
    public void notifyPreferenceChanged(final String preferenceKey) {
        invokeLater(new Runnable() {
            @Override
            public void run() {
                WearableApplication.deviceService(mDevice).onSendConfiguration(preferenceKey);
            }
        });
    }
    ...
    public Prefs getPrefs() {
        return new Prefs(getPreferenceManager().getSharedPreferences());
    }

    // Enable/Disable all preferences in the root screen
    public void setState(boolean enabled) {
        if (mPreferenceScreen == null) {
            return;
        }

        mPreferenceScreen.setEnabled(enabled);
    }
    ...
    protected Set<String> getPreferenceKeysWithSummary() {
        ...
        if (mCustomizer != null) {
            keysWithSummary.addAll(mCustomizer.getPreferenceKeysWithSummary());
        }
