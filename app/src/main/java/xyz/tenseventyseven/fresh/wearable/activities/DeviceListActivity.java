...
import xyz.tenseventyseven.fresh.databinding.WearActivityDeviceListBinding;
import xyz.tenseventyseven.fresh.wearable.adapters.DeviceListItemAdapter;

public class DeviceListActivity extends AbstractNoActionBarActivity implements
        AdapterView.OnItemClickListener,
        AdapterView.OnItemLongClickListener {
    private WearActivityDeviceListBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = WearActivityDeviceListBinding.inflate(getLayoutInflater());
    ...
    private void setupDeviceList() {
        mDeviceManager = Application.app().getDeviceManager();
    ...
    private final MenuProvider menuProvider = new MenuProvider() {
        ...
        public void onCreateMenu(@NonNull Menu menu, MenuInflater inflater) {
            inflater.inflate(R.menu.wear_device_list_menu, menu);
