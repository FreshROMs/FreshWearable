...
public class DevicesFragment extends Fragment {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (Objects.requireNonNull(action)) {
                ...
                case WearableApplication.ACTION_NEW_DATA:
                    if (action.equals(WearableApplication.ACTION_NEW_DATA)) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        deviceManager = ((WearableApplication) getActivity().getApplication()).getDeviceManager();
    ...
    private void showFabIfNeccessary() {
        if (WearableApplication.getPrefs().getBoolean("display_add_device_fab", true)) {
            fab.show();
        } else {
    ...
    public class RefreshTask extends DBAccess {
        ...
        private void updateDevice(final DBHandler db, final GBDevice gbDevice) {
            ...
            final boolean showActivityCard = WearableApplication.getDevicePrefs(gbDevice).getBoolean(DeviceSettingsPreferenceConst.PREFS_ACTIVITY_IN_DEVICE_CARD, true);
