...
public class DeviceSettingsPreferenceConst {
    ...
    public static final String PREF_EARBUDS_ABOUT = "pref_screen_earbuds_about";
    public static final String PREF_WATCH_ABOUT = "pref_screen_watch_about";
...
//    public static final String PREF_REDMI_BUDS_SURROUND_SOUND="pref_redmi_buds_surround_sound";
//    public static final String PREF_REDMI_BUDS_SURROUND_SOUND_MODE="pref_redmi_buds_surround_sound_mode";
