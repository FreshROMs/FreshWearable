...
public class CameraActivity extends AppCompatActivity {
    ...
    public static boolean supportsCamera() {
        return WearableApplication.getContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_ANY);
    }

    public static boolean hasCameraPermission() {
        return WearableApplication.getContext().checkCallingOrSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!supportsCamera()) {
            ...
            WearableApplication.deviceService().onCameraStatusChange(GBDeviceEventCameraRemote.Event.EXCEPTION, null);
            reportClosing = false;
            finish();
            return;
        }
    ...
    private void handleIntent(Intent intent) {
        ...
        if (event == GBDeviceEventCameraRemote.Event.CLOSE_CAMERA) {
            finish();
             ...
             WearableApplication.deviceService().onCameraStatusChange(GBDeviceEventCameraRemote.Event.OPEN_CAMERA, null);
            ...
            imageCapture.takePicture(outputFileOptions, ContextCompat.getMainExecutor(this), new ImageCapture.OnImageSavedCallback() {
                ...
                public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                    ...
                    WearableApplication.deviceService().onCameraStatusChange(
    ...
    protected void onStop() {
        ...
        if (reportClosing)
            WearableApplication.deviceService().onCameraStatusChange(GBDeviceEventCameraRemote.Event.CLOSE_CAMERA, null);
    }
}
