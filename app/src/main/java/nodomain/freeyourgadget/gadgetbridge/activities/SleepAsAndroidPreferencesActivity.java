...
public class SleepAsAndroidPreferencesActivity extends AbstractSettingsActivityV2 {
    ...
    public static class SleepAsAndroidPreferencesFragment extends AbstractPreferenceFragment {
        ...
        public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
            ...
            if (sleepAsAndroidDevices != null) {
                ...
                sleepAsAndroidDevices.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(@NonNull Preference preference, Object newValue) {
                        GBDevice device = WearableApplication.app().getDeviceManager().getDeviceByAddress(newValue.toString());
                        if (device != null) {

                            WearableApplication.getPrefs().getPreferences().edit().putString("sleepasandroid_device", device.getAddress()).apply();
            ...
            String defaultDeviceAddr = WearableApplication.getPrefs().getString("sleepasandroid_device", "");
            if (!defaultDeviceAddr.isEmpty()) {
                GBDevice device = WearableApplication.app().getDeviceManager().getDeviceByAddress(defaultDeviceAddr);
                if (device != null) {
            ...
            if (!defaultDeviceAddr.isEmpty()) {
                ...
                if (device != null) {
                    ...
                    if (maxAlarmSlots > 0) {
                        ...
                        int reservedAlarmSlots = WearableApplication.getPrefs().getInt(DeviceSettingsPreferenceConst.PREF_RESERVER_ALARMS_CALENDAR, 0);
