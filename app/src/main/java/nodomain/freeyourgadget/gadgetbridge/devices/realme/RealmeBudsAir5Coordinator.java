...
public class RealmeBudsAir5Coordinator extends OppoHeadphonesCoordinator {
    @Override
    protected Pattern getSupportedDeviceName() {
        return Pattern.compile("realme Buds Air 5", Pattern.LITERAL);
    }
    ...
    public int getDeviceNameResource() {
        return R.string.devicetype_realme_buds_air5;
    }
