...
public class GreeAcPairingActivity extends AbstractActionBarActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final DevicePrefs devicePrefs = new DevicePrefs(Application.getDeviceSpecificSharedPrefs(deviceCandidate.getMacAddress()), gbDevice);
        ...
        buttonPair.setOnClickListener(v -> {
            ...
            Application.deviceService(gbDevice).connect(true);
        });
