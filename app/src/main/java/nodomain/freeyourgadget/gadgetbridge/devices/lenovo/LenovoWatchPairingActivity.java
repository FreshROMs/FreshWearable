/*  Copyright (C) 2019-2024 Andreas Böhler, José Rebelo, mamucho, mkusnierz,
    Taavi Eomäe
...
public class LenovoWatchPairingActivity extends AbstractActionBarActivity implements BondingInterface {
