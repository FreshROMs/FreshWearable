...
public class RtlUtils {
    ...
    {
        return WearableApplication.getPrefs().getBoolean(GBPrefs.RTL_SUPPORT, false);
    }
    ...
    {
        return WearableApplication.getPrefs().getBoolean(GBPrefs.RTL_CONTEXTUAL_ARABIC, false);
    }
    ...
    public static String fixRtl(String oldString) {
        ...
        int line_max_size = WearableApplication.getPrefs().getInt("rtl_max_line_length", 18);
