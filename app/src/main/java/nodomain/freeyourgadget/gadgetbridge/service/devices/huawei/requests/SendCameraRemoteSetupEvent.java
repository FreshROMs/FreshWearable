...
public class SendCameraRemoteSetupEvent extends Request {
    ...
    protected boolean requestSupported() {
        return supportProvider.getHuaweiCoordinator().supportsCameraRemote() && Application.getDeviceSpecificSharedPrefs(supportProvider.getDevice().getAddress()).getBoolean(DeviceSettingsPreferenceConst.PREF_CAMERA_REMOTE, false);
    }
