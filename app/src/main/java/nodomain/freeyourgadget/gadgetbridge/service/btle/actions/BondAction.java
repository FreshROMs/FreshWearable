...
public class BondAction extends PlainAction implements BondingInterface {
    ...
    public void unregisterBroadcastReceivers() {
        AndroidUtils.safeUnregisterBroadcastReceiver(LocalBroadcastManager.getInstance(WearableApplication.getContext()), pairingReceiver);
        AndroidUtils.safeUnregisterBroadcastReceiver(WearableApplication.getContext(), bondingReceiver);
    }

    @Override
    public void registerBroadcastReceivers() {
        LocalBroadcastManager.getInstance(WearableApplication.getContext()).registerReceiver(pairingReceiver, new IntentFilter(GBDevice.ACTION_DEVICE_CHANGED));
    ...
    public Context getContext() {
        return WearableApplication.getContext();
    }
