...
public class SetTemperatureUnitSetting extends Request {
    ...
    protected List<byte[]> createRequest() throws RequestCreationException {
        String temperatureScale = WearableApplication.getDeviceSpecificSharedPrefs(this.getDevice().getAddress()).getString(DeviceSettingsPreferenceConst.PREF_TEMPERATURE_SCALE_CF, "");
