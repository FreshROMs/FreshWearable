...
public class DeviceSupportFactory {
    ...
    public synchronized DeviceSupport createDeviceSupport(GBDevice device) throws WearableException {
    ...
    private DeviceSupport createClassNameDeviceSupport(GBDevice device) throws WearableException {
        ...
        try {
            ...
            throw new WearableException("Error creating DeviceSupport instance for " + className, e);
        }
    }
    ...
    private ServiceDeviceSupport createServiceDeviceSupport(GBDevice device) throws WearableException {
    ...
    private DeviceSupport createBTDeviceSupport(GBDevice gbDevice) throws WearableException {
        if (mBtAdapter != null && mBtAdapter.isEnabled()) {
            try {
                ...
                throw new WearableException(mContext.getString(R.string.cannot_connect_bt_address_invalid_), e);
            }
        }
        return null;
    }

    private DeviceSupport createTCPDeviceSupport(GBDevice gbDevice) throws WearableException {
        try {
            ...
            throw new WearableException("cannot connect to " + gbDevice, e); // FIXME: localize
        }
    }
