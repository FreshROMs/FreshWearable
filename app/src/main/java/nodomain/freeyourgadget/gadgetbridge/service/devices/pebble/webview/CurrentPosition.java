...
public class CurrentPosition {
    ...
    public CurrentPosition() {
        ...
        if (ActivityCompat.checkSelfPermission(WearableApplication.getContext(), Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED &&
                prefs.getBoolean("use_updated_location_if_available", false)) {
            LocationManager locationManager = (LocationManager) WearableApplication.getContext().getSystemService(Context.LOCATION_SERVICE);
