...
public class FirmwareFilePutRequest extends FilePutRawRequest {
    ...
    public void onPacketWritten(TransactionBuilder transactionBuilder, int packetNr, int packetCount) {
        ...
        transactionBuilder.add(new SetProgressAction(Application.getContext().getString(R.string.updatefirmwareoperation_update_in_progress), true, progressPercent, Application.getContext()));
    }
