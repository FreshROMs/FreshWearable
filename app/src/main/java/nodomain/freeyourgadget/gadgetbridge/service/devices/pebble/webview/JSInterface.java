    ...
    public String sendAppMessage(String msg, String needsTransactionMsg) {
        ...
        try {
            ...
            if (needsTransaction) {
                ...
                Application.deviceService().onAppConfiguration(this.mUuid, out.toString(), this.lastTransaction);
                return this.lastTransaction.toString();
            } else {
                Application.deviceService().onAppConfiguration(this.mUuid, out.toString(), null);
            }
