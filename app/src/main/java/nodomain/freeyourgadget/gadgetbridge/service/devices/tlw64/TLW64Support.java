...
public class TLW64Support extends AbstractBTLEDeviceSupport {
    ...
    private void setDisplaySettings(TransactionBuilder transaction) {
        ...
        String timeformat = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getString(DeviceSettingsPreferenceConst.PREF_TIMEFORMAT, "auto");
        switch (timeformat) {
            case "24h":
                displayBytes[2] = 1;
                break;
    ...
    private void sendSettings(TransactionBuilder builder) {
        ...
        if (WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getBoolean(DeviceSettingsPreferenceConst.PREF_LIFTWRIST_NOSHED, false)) {
        ...
        if (WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getBoolean(DeviceSettingsPreferenceConst.PREF_INACTIVITY_ENABLE_NOSHED, false)) {
