...
public class BandWPSeriesDeviceSupport extends AbstractBTLEDeviceSupport {
    ...
    private boolean handleGetAncModeStateResponse(BandWPSeriesResponse response) {
        ...
        Editor editor = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).edit();
    ...
    private boolean handleGetVptEnabledResponse(BandWPSeriesResponse response) {
        ...
        int vptLevel = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getInt(PREF_BANDW_PSERIES_VPT_LEVEL, 0);
        Editor editor = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).edit();
    ...
    private boolean handleGetVptLevelResponse(BandWPSeriesResponse response) {
        ...
        boolean vptEnabled = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getBoolean(PREF_BANDW_PSERIES_VPT_ENABLED, false);
        Editor editor = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).edit();
        ...
        try {
            ...
            switch (config) {
                case PREF_ACTIVE_NOISE_CANCELLING_TOGGLE:
                    boolean ancMode = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getBoolean(PREF_ACTIVE_NOISE_CANCELLING_TOGGLE, true);
                    BandWBLEProfile.setAncModeState(builder, ancMode);
                    break;
                case PREF_BANDW_PSERIES_GUI_VPT_LEVEL:
                    int level = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getInt(PREF_BANDW_PSERIES_GUI_VPT_LEVEL, 0);
                ...
                case PREF_WEAR_SENSOR_TOGGLE:
                    boolean wearSensorEnabled = WearableApplication.getDeviceSpecificSharedPrefs(gbDevice.getAddress()).getBoolean(PREF_WEAR_SENSOR_TOGGLE, true);
